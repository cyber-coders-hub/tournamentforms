...
<body>
    <table class="table">
        ...
        <tbody>
            <tr>
                <td>1</td>
                <td><?php echo $room['morningid']; ?></td>
                <td><?php echo $room['morningpass']; ?></td>
                <td><?php echo $room['eveningid']; ?></td>
                <td><?php echo $room['eveningpass']; ?></td>
                <td>
                    <a name="" id="" class="btn btn-primary" href="edit.php?id=1" role="button">Edit</a>
                </td>
            </tr>
        </tbody>
    </table>
