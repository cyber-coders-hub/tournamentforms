...
<nav class="navbar navbar-expand-sm navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="collapsibleNavId">
        ...
        <a name="" id="" class="btn btn-primary mr-2" href="index.php" role="button">View/Hide Active Tournament</a>
        <a name="" id="" class="btn btn-primary mr-2" href="edit.php" role="button">Add link</a>
...
<body>
    ...
    $links = $selectres->fetch_assoc();

    if(isset($_POST['submit']))
    {
        $link = $_POST['link'];
        $update = "UPDATE showhide set link = '$link' WHERE id = '1'";
        $updateres = mysqli_query($conn,$update);
        echo header('Location: ../manage/index.php?msg=editsuccess');
    }
    ?>
    <div class="container">
        <form action="" method="post">
            <div class="form-group">
              ...
              <input type="link" class="form-control" name="link" id="" aria-describedby="emailHelpId" placeholder="<?php echo $links['link']; ?>">
